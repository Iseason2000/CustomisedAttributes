        ...
        switch (args[0]) {
            ...
            case "addMaxHealth":
                ...
                if (arg2.contains("%")) {
                    ...
                    new HealthModifier.Timer(player, player.getMaxHealth() * p, HealthModifier.toInt(args[2]));
                } else {
                    new HealthModifier.Timer(player, HealthModifier.toDouble(arg2), HealthModifier.toInt(args[2]));
                }
                break;
